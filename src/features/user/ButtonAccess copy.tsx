  ...
  return (
    <div className="min-h-screen w-full flex items-start justify-center bg-gradient-to-br from-blue-50 to-blue-100 p-3 sm:p-4 overflow-y-auto">
      <div className="w-full max-w-md sm:max-w-2xl bg-white rounded-2xl shadow-2xl p-4 sm:p-6 md:p-10">
        ...
        <div className="bg-blue-50 rounded-xl p-3 sm:p-5 mb-4 sm:mb-6">
          <div className="flex items-start gap-3 mb-3 sm:mb-4">
            <MdSecurity className="w-6 h-6 text-blue-primary flex-shrink-0 mt-1" />
            <div>
        ...
        <div className="space-y-3 mb-4 sm:mb-6">
          <h3 className="font-bold text-gray-800 text-sm sm:text-base flex items-center gap-2">
            <MdLock className="w-5 h-5 text-blue-primary" />
        ...
        <div className="bg-gray-50 rounded-xl p-3 sm:p-5 border border-gray-200 mb-6">
          <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
            ...
            <a
              ...
              className="text-blue-primary hover:text-blue-secondary underline font-medium"
            >
